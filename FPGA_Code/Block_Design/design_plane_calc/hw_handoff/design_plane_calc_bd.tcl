...
################################################################
# This is a generated script based on design: design_plane_calc
#
...
# source design_plane_calc_script.tcl
...
set design_name design_plane_calc
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT5_PORT {i2c_scl} \
   CONFIG.CLK_OUT6_PORT {clk_out6} \
   CONFIG.CLK_OUT7_PORT {clk_i2c} \
   ...
   CONFIG.MMCM_CLKOUT4_DUTY_CYCLE {0.3} \
   CONFIG.MMCM_CLKOUT4_PHASE {0} \
   CONFIG.MMCM_CLKOUT5_DIVIDE {125} \
   CONFIG.MMCM_CLKOUT6_DIVIDE {125} \
   CONFIG.MMCM_CLKOUT6_DUTY_CYCLE {0.5} \
   CONFIG.MMCM_CLKOUT6_PHASE {0} \
   CONFIG.MMCM_STARTUP_WAIT {true} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins data_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports ToF_SCL] [get_bd_pins top_0/ToF_SCL]
  connect_bd_net -net Net1 [get_bd_ports ToF_SDA] [get_bd_pins top_0/ToF_SDA]
  connect_bd_net -net ToF_INT_1 [get_bd_ports ToF_INT] [get_bd_pins top_0/ToF_INT]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_i2c [get_bd_pins clk_wiz_0/clk_i2c] [get_bd_pins top_0/i2c_t8_clk]
  connect_bd_net -net clk_wiz_0_i2c_scl [get_bd_pins clk_wiz_0/i2c_scl] [get_bd_pins top_0/i2c_scl_clk]
  connect_bd_net -net data_ip_0_ToF_CMD_in [get_bd_pins data_ip_0/ToF_CMD_in] [get_bd_pins top_0/ToF_CMD_in]
  connect_bd_net -net data_ip_0_i2c_data_to_send [get_bd_pins data_ip_0/i2c_data_to_send] [get_bd_pins top_0/i2c_data_to_send]
  connect_bd_net -net data_ip_0_register_address_in [get_bd_pins data_ip_0/register_address_in] [get_bd_pins top_0/register_address_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins data_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins data_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs data_ip_0/S00_AXI/S00_AXI_reg] SEG_data_ip_0_S00_AXI_reg
